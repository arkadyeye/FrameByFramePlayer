...
public class VideoDecoderThread extends Thread {
    ...
    private boolean continuesPlaying = true;
    private boolean playNextFrame = false;
    ...
    public boolean init(Surface surface, AssetFileDescriptor filePath) {
        ...
        try {
            ...
            for (int i = 0; i < mExtractor.getTrackCount(); i++) {
                ...
                Log.i(MainActivity.TAG,format.toString());
    ...
    public void run() {
        ...
        while (!eosReceived) {
            ...
            Log.i(MainActivity.TAG, "continuesPlaying: "+continuesPlaying + "playNextFrame: "+playNextFrame);

            if (continuesPlaying || playNextFrame) {
