...
/*
    Added by Arkady G. the code is frmo here:
    https://www.javatips.net/api/sample-tensorflow-imageclassifier-master/app/src/main/java/com/example/androidthings/imageclassifier/env/ImageUtils.java
